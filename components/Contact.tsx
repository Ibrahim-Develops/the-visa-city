...
const Contact = () => {
    return (
        <div className=''>
            <div className="relative px-20 bg-gray-200 text-black py-16 overflow-hidden">
                <div className=" items-start justify-between relative z-10">
                    <div className="mb-10 md:mb-0">
                        <p className="text-lg text-gray-600 mb-2 font-semibold">Have any queries?</p>
                        <h1 className="text-5xl font-bold mb-4">
                            We’re Here To <span className="text-[#4b6391]">Help.</span>
                        </h1>
            ...
            <div className="bg-[#f9fafb] py-12 px-20 rounded-2xl">
                <h2 className="text-3xl font-bold mb-10 text-black">Contact Us</h2>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 text-sm text-gray-800">
                    <div>
                        <h4 className="font-semibold mb-2 text-black">Address</h4>
                        <p>
                    ...
                    <div>
                        <h4 className="font-semibold mb-2 text-black">Information Collected</h4>
                        <p>+971 58 5669976</p>
                        <p className="mt-2">Open: Mon - Fri, 9am - 6pm</p>
                    </div>

                    <div>
                        <h4 className="font-semibold mb-2 text-black">Land Phone</h4>
                        <p>+971 58 5669976</p>
                        <p className="mt-2 text-gray-600">For general inquiries & support</p>
                    </div>

                    <div>
                        <h4 className="font-semibold mb-2 text-black">Email Us</h4>
                        <p>contact@thevisacity.com</p>
                        <p className="mt-2 text-gray-600">We usually respond in 24 hours</p>
                    </div>

                    <div>
                        <h4 className="font-semibold mb-2 text-black">Social Media</h4>
                        <div className="flex items-center space-x-4 text-xl text-black">
                            <FaXTwitter className="cursor-pointer text-gray-500 hover:text-black transition" />
                ...
                <div className="mt-10 flex flex-col md:flex-row items-center gap-4">
                    <button className="bg-[#072343] duration-300 hover:scale-105 cursor-pointer text-white font-semibold px-6 py-3 rounded-xl transition-all">
                        Call Now!
                    </button>
